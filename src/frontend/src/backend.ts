...
export class Backend implements backendInterface {
    ...
    async getAllGrammarTipsByCategory(): Promise<Array<GrammarTip>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllGrammarTipsByCategory();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getAllLessonsByRating(): Promise<Array<Lesson>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllLessonsByRating();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPhrasesByCategory(): Promise<Array<Phrase>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPhrasesByCategory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGrammarTips(arg0: string | null): Promise<Array<GrammarTip>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGrammarTips(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLessons(arg0: string | null): Promise<Array<Lesson>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLessons(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPhrases(arg0: string | null): Promise<Array<Phrase>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhrases(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
